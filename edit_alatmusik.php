...
$query = mysqli_query($connect, "select * from alatmusik where id_alatmusik='$id_alatmusik'") or die(mysqli_error($connect));
...
<head>
    ...
    <title>Edit Alat Musik - AB Instrument</title>
            ...
            <div class="container-fluid">
                <div class="col">
                        <div class="card shadow">
                            <div class="card-body">
                                <form method="post" action="aksi_editalatmusik.php?id_alatmusik=<?php echo $id_alatmusik; ?>">
                                    <div class="form-group">
                                        <label>
                                            <strong>Kode Alat Musik</strong>
                                            <br>
                                        </label>
                                        <input disabled value="<?php echo $id_alatmusik; ?>" class="form-control" type="text" name="id_alatmusik" value="<?php echo $row['id_alatmusik']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            <strong>Merk</strong>
                                        ...
                                        <input value="<?php echo $merk; ?>" class="form-control" type="text" name="merk" value="<?php echo $row['merk']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            <strong>Tipe</strong>
                                        ...
                                        <input value="<?php echo $tipe; ?>" class="form-control" type="text" name="tipe" value="<?php echo $row['tipe']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            <strong>Jenis</strong>
                                        ...
                                        $queryjenis = "SELECT jenis FROM alatmusik where id_alatmusik= $id_alatmusik";
                                        $resultjenis = mysqli_query($connect, $queryjenis) or die(mysqli_error($connect));
                                        $rowjenis = mysqli_fetch_array($resultjenis); ?> 
                                        <select class="form-control" name="jenis">
                                            <?php foreach( $optionjenis as $var => $optionjenis ): ?>
                                            <option value="<?php echo $var ?>"<?php if( $var == $rowjenis['jenis'] ): ?> selected="selected"<?php endif; ?>><?php echo $optionjenis ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $harga_sewa; ?>" class="form-control" type="text" name="harga_sewa" value="<?php echo $row['harga_sewa']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                        ...
                                        $querystatus = "SELECT status FROM alatmusik where id_alatmusik= $id_alatmusik";
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option value="<?php echo $var ?>"<?php if( $var == $rowstatus['status'] ): ?> selected="selected"<?php endif; ?>><?php echo $optionstatus ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <br>
