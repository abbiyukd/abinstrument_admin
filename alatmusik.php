...
<head>
    ...
    <title>Data Alat Musik - AB Instrument</title>
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <ul class="nav">
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            <form class="form-inline mr-auto navbar-search w-100" action="alatmusik.php" method="get">
            ...
            <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Daftar Alat Musik</p>
                        </div>
                        <div class="card-body">
                            <a class="card-link" href="tambah_alatmusik.php"><button class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Tambah Alat Musik</button></a>
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query = "select * from alatmusik where merk like '%".$search."%' or tipe like '%".$search."%' or jenis like '%".$search."%' or status like '%".$search."%' or harga_sewa like '%".$search."%'";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        }
                                        else {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo rupiah($harga_sewa) ?></td>
                                                <td><?php echo $row['status']; ?></td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href='edit_alatmusik.php?id_alatmusik=<?php echo $row['id_alatmusik']; ?>'>
                                                            <button class="btn btn-primary btn-success" type="button">
                                                                <i class="fa fa-edit"></i>Edit</button>
                                                        </a>
                                                        <a href='hapus_alatmusik.php?id_alatmusik=<?php echo $row['id_alatmusik']; ?>'>
