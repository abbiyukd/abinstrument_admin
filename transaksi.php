...
<head>
    ...
    <title>Data Transaksi- AB Instrument</title>
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <ul class="nav">
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            <form class="form-inline mr-auto navbar-search w-100" action="transaksi.php" method="get">
            ...
            <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Daftar Transaksi</p>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query = "select * from transaksi where id_penyewa like '%".$search."%' or tgl_pinjam like '%".$search."%' or tgl_kembali like '%".$search."%'";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        }
                                        else {
