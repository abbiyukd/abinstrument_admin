...
<head>
    ...
    <title>Data Penyewa - AB Instrument</title>
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <ul class="nav">
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            <form class="form-inline mr-auto navbar-search w-100" action="penyewa.php" method="get">
                                        <div class="input-group"><input class="bg-light form-control border-0 small" type="text" name="search" placeholder="Cari penyewa ...">
            ...
            <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Daftar Penyewa</p>
                        </div>
                        <div class="card-body">
                            <a class="card-link" href="tambah_penyewa.php"><button class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Tambah Penyewa</button></a>
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query = "select * from penyewa where id_penyewa like '%".$search."%' or nama like '%".$search."%' or alamat like '%".$search."%' or no_hp like '%".$search."%'";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        }
                                        else {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href='edit_penyewa.php?id_penyewa=<?php echo $row['id_penyewa']; ?>'>
                                                            <button class="btn btn-primary btn-success" type="button">
                                                                <i class="fa fa-edit"></i>Edit</button>
                                                        </a>
                                                        <a href='hapus_penyewa.php?id_penyewa=<?php echo $row['id_penyewa']; ?>'>
