...
<head>
    ...
    <title>View Penyewa - AB Instrument</title>
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="view_penyewa.php">Penyewa</a>
                            </div>
                        </li>
                        <li class="nav-item">
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            <form class="form-inline mr-auto navbar-search w-100" action="view_penyewa.php" method="get">
            ...
            <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Penyewa X Transaksi</p>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query = "select * from penyewaxtransaksi where id_penyewa like '%".$search."%' or nama like '%".$search."%' or alamat like '%".$search."%' or no_hp like '%".$search."%'";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        }
                                        else {
                                            $query = "select * from penyewaxtransaksi";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        } 
                                        while ($row = mysqli_fetch_array($result)) {
                                        ?>
