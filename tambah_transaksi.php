...
<head>
    ...
    <title>Tambah Transaksi - AB Instrument</title>
            ...
            <div class="container-fluid">
                <div class="col">
                        <div class="card shadow">
                            <div class="card-body">
                                <form method="post" action="aksi_tambahtransaksi.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php 
                                            ...
                                            while($row = mysqli_fetch_array($result)) { 
                                        ?>
                                            <option value="<?php echo $row['id_penyewa'];	?>"><?php echo $row['nama']; ?> - <?php echo $row['id_penyewa']; ?></option>
                                        <?php } ?>
                                         </select> 
                                    </div>
                                    <div class="form-group">
